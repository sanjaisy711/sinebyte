        ...
        <div className="container relative">
          <div className="grid grid-cols-1 mt-10 text-center">
            <h3 className="font-bold uppercase leading-normal text-4xl mb-5">
              Welcome to the sinebyte Forum
            </h3>

            <p className="text-slate-400 text-lg mx-auto">
              we are here to help. Get in touch and We will get back to you as
              soon as we can
            </p>
            ...
            <div className="relative -mt-12 rounded-md shadow dark:shadow-gray-800 overflow-hidden bg-white dark:bg-slate-900">
              <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                <div className="md:col-span-6">
                  <div
                    className="w-full py-52 bg-slate-400 bg-no-repeat bg-top bg-cover jarallax"
                ...
                <div className="md:col-span-6">
                  <div className="p-6">
                    ...
                    <p className="text-slate-400 max-w-xl">
                      Talk about anything that is on your mind and see what
                    ...
                    <div className="mt-6">
                      <Link
                        href="#"
                        className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded me-2 mt-2"
                      >
                        Register Now!
                      </Link>
                    </div>
