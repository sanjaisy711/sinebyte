            ...
            <div className="lg:w-3/4 rounded-md shadow dark:shadow-gray-800 h-fit bg-white dark:bg-slate-900">
              <div className="p-6">
                <h5 className="text-xl font-bold">
                  Version <span className="text-emerald-600">2.3.0</span> - 5th
                  September 2024
                </h5>
                <ul className="list-none mb-10">
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Add : Added new Page Service Detail (page-service-detail)
                    demo
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the Next Version 14.2.7
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the React Version 18.3.1
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the React CountUp Version 6.5.3
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the React Icon Version 5.3.0
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the React Modal Video Version 2.0.2
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the React Responsive Masonry Version 2.3.0
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the React Router Dom Version 6.26.1
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the ckeditor Version 43.0.0
                  </li>

                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the Full calendar Version 6.1.15
                  </li>

                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the Full calendar react Version 6.1.15
                  </li>

                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the Simplebar React Version 3.2.6
                  </li>
                </ul>

                <h5 className="text-xl font-bold">
                  Version <span className="text-emerald-600">2.2.0</span> - 9th
                  March 2024
                </h5>
                <ul className="list-none mb-8">
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated CSS to SCSS and also you can change inline
                    css as per Tailwind CSS in code
                  </li>

                  <li className="items-center text-slate-400 mt-8 mb-3 ms-2 text-lg">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Admin Dashboard:
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                ...
                <h5 className="text-xl font-bold">
                  Version <span className="text-emerald-600">2.1.0</span> - 11th
                  December 2023
                </h5>
                <ul className="list-none mb-8">
                  <li className="items-center text-slate-400 my-3 ms-2 text-lg">
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated Data file and moved all the variable
                    declaration out side of the components
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                ...
                <h5 className="text-xl font-bold">
                  Version <span className="text-emerald-600">2.0.0</span> - 21th
                  September 2023
                </h5>
                <ul className="list-none mb-8">
                  <li className="items-center text-slate-400 my-3 ms-2 text-lg">
                ...
                <h5 className="text-xl font-bold">
                  Version <span className="text-emerald-600">1.0.0</span> - 19th
                  August 2023
                </h5>
                <ul className="list-none mb-8">
                  <li className="items-center text-slate-400 my-3 ms-2">
