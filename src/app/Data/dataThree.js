...
export const consultingProduct = [
  {
    ...
    title: "sinebyte Personal Portfolio",
    name: "Creative",
  },
  {
    image: "/images/portfolio/pro2.jpg",
    title: "sinebyte Minimal Portfolio",
    name: "Minimal",
  },
  {
    image: "/images/portfolio/pro3.jpg",
    title: "sinebyte NFT Market",
    name: "Crypto",
  },
  {
    image: "/images/portfolio/pro4.jpg",
    title: "sinebyte Portfolio",
    name: "Portfolio",
  },
  {
    image: "/images/portfolio/pro5.jpg",
    title: "sinebyte Constuction",
    name: "Corporate",
  },
  {
...
export const studentData = [
  {
    ...
    title2: "student",
    des2: "There are so many things I had to do with my old software that I just Do not do at all with sinebyte. Suspicious but I can not say I Do not love it.",
  },
  {
    image: "/images/client/02.jpg",
    name: "Carl Oliver",
    title: "student",
    des: "The best part about sinebyte is every time I pay my employees, my bank balance doesn't go down like it used to. Looking forward to spending this extra cash when I figure out why my card is being declined.",
  ...
  },
  {
    ...
    title: "student",
    des: "I used to have to remit tax to the EU and with sinebyte I somehow Do not have to do that anymore. Nervous to travel there now though.",
...
export const forumData = [
  ...
  },
  {
    image: "/images/client/03.jpg",
    title:
      "sinebyte includes the ability to create a better of sites by using the multisite feature.",
    name: "Tara Arrington",
    desc: "This forum is for our announcements. Only our staff can create new topics.",
  },
];
...
export const lowClient = [
  {
    ...
    title1: "C.E.O",
    desc1:
      "There are so many things I had to do with my old software that I just Do not do at all with sinebyte. Suspicious but I can not say I Do not love it.",
  },
  {
    image: "/images/client/03.jpg",
    name: "Carl Oliver",
    title: "C.E.O",
    desc: "The best part about sinebyte is every time I pay my employees, my bank balance doesn't go down like it used to. Looking forward to spending this extra cash when I figure out why my card is being declined.",
  ...
  },
  {
    ...
    name: "Barbara McIntosh",
    title: "C.E.O",
    desc: "I used to have to remit tax to the EU and with sinebyte I somehow Do not have to do that anymore. Nervous to travel there now though.",
