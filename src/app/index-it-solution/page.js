...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative table w-full py-36 pb-0 lg:py-44 lg:pb-0 bg-indigo-600  bg-center bg-no-repeat bg-cover"
            ...
            <div className="lg:col-span-7">
              <div className="md:me-6 md:mb-20">
                ...
                <div className="mt-6">
                  ...
                  >
                    <FaRegEnvelope className="me-2 text-sm" /> Get Started
                  </Link>
                </div>
              </div>
            </div>
