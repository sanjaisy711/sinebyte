      ...
      <div className="container relative">
        ...
        <div id="navigation" style={{ display: isMenu ? "block" : "none" }}>
          <ul className="navigation-menu nav-light justify-end">
            <li className={manu === "/index-photography" ? "active" : ""}>
              <Link href="/index-photography" className="sub-menu-item">
                Home
              </Link>
            </li>
            <li className={manu === "/photography-about" ? "active" : ""}>
              <Link href="/photography-about" className="sub-menu-item">
                About Us
              </Link>
            </li>
            <li className={manu === "/photography-portfolio" ? "active" : ""}>
              <Link href="/photography-portfolio" className="sub-menu-item">
                Portfolio
              </Link>
            </li>
            <li className={manu === "/contact-two" ? "active" : ""}>
