...
import CountryDropdown from "./CountryCodeSelector";
    ...
    <div className="mb-4p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800">
      <div className="relative bg-transparent flex">
        <PhoneInput
          ...
          className="backgroundCountryCode peer h-10 w-24 rounded-l-lg border border-gray-300 dark:bg-transparent txt-sm text-gray-900 ring-2 ring-gray-500 focus:border-indigo-600 focus:outline-none dark:border-gray-600 dark:text-slate-700 dark:ring-gray-700 dark:focus:border-indigo-600 dark:bg-slate-900"
        />
