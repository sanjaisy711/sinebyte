...
export default function Cta() {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: "url('/images/digital/bg01.jpg')" }}
    >
        ...
        <div className="flex">
          <div className="lg:w-1/3 md:1/2 sm:w-2/3 p-6 rounded-md shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900">
            ...
            <p className="text-slate-400 mb-0">
              Certain internet providers exploit the fact that fill text cannot
              be recognized by automatic search engines - meaningful information
              cannot be distinguished from meaningless.
            </p>
