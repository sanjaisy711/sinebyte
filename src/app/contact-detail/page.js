...
export default function Page() {
  return (
    <>
      ...
      <section
        className="md:h-screen flex py-36 w-full items-center bg-center bg-no-repeat bg-cover"
                ...
                <div className="lg:col-span-5 md:col-span-6">
                  <div className="p-6">
                    <h3 className="mb-6 text-2xl leading-normal font-medium">
                      Lets talk about your portfolio
                    </h3>
                    ...
                    <ul className="list-none mt-5 space-x-1 space-y-1">
                      <li className="inline">
                        <Link
                          href="#"
                          className="size-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center border border-gray-100 dark:border-gray-800 rounded-md hover:border-indigo-600 hover:text-white hover:bg-indigo-600"
                        >
                  ...
                  <div className="flex justify-center text-center p-6 border-t border-gray-100 dark:border-gray-800">
                    <p className="mb-0 text-slate-400">
                      © {new Date().getFullYear()} sinebyte. Design & Develop
