...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative table w-full py-36 lg:py-64  bg-no-repeat sm:bg-left bg-right overflow-hidden bg-cover"
        style={{ backgroundImage: "url('/images/it/bg.jpg')" }}
      >
            ...
            <div className="md:col-span-7">
              <div className="md:me-6">
                ...
                <p className="text-slate-400 text-lg max-w-xl">
                  Start working with sinebyte that can provide everything you
                ...
                <div className="mt-6">
                  <Link
                    href="#"
                    className="py-2 px-5 me-2 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"
                  >
                    Contact Us
                  </Link>
                  <VideoModalThree />
