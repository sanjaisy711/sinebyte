              ...
              <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
                {studioAbout.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-16 h-16 bg-indigo-600/5 border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800">
