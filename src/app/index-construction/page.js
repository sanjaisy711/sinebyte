  ...
  return (
    <>
                  ...
                  <div className="lg:col-span-4 order-1 lg:order-2 bg-indigo-600">
                    <div className="p-[30px] lg:text-start text-center">
                      ...
                      <p className="text-white/75 max-w-xl mx-auto">
                        Start working with sinebyte that can provide everything
            ...
            <div className="md:col-span-7">
              <div className="lg:ms-4">
                ...
                <h4 className="mb-6 mt-4 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Worlds largest and <br /> trusted construction company
                </h4>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/construction/bg2.jpg')" }}
      >
