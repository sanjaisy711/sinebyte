...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative table w-full py-36 lg:py-56 bg-indigo-600 bg-center bg-no-repeat bg-cover"
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 text-center mt-10">
            ...
            <div className="relative mt-8">
              <Link
                href="#"
                className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-gray-50 hover:bg-gray-200 dark:bg-slate-900 dark:hover:bg-gray-700 hover:border-gray-100 dark:border-gray-700 dark:hover:border-gray-700 rounded-md"
              >
                Get Started
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            ...
            <div className="md:col-span-6">
              <div className="lg:ms-5">
                ...
                <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                  Powerful Digitalization <br /> With sinebyte
                </h3>
                ...
                <p className="text-slate-400 max-w-xl mb-6">
                  ...
                  sinebyte network, and much more with just a few taps. commodo
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            ...
            <div className="lg:col-span-7 md:col-span-6 order2 md:order-1">
              <div className="lg:me-5">
                ...
                <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                  sinebyte Marketing <br /> Analytics For All Expenses
                </h3>
                      ...
                      <div className="mt-8">
                        <div className="section-title text-md-start">
                          ...
                          <h3 className="md:text-3xl text-2xl md:leading-normal leading-normal font-semibold text-white mt-2">
                            Get An Easy Start <br /> With sinebyte Now
                          </h3>
                        </div>
                      </div>
                      ...
                      <div className="mt-8">
                        <div className="section-title text-md-start">
                          <p className="text-white/50 max-w-xl mx-auto mb-2">
                            Start working with sinebyte that can provide
