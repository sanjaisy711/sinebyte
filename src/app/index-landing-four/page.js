...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative table w-full py-36 lg:py-44 bg-gray-50 dark:bg-slate-800 bg-bottom bg-cover"
        id="home"
          ...
          <div className="grid lg:grid-cols-12 md:grid-cols-2 mt-10 items-center gap-[30px]">
            <div className="lg:col-span-7">
              ...
              <div className="relative mt-10">
                <Link
                  href="#"
                  className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full me-1"
                >
                  Get Started
                </Link>
                <VideoModalThree />
