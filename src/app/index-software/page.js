...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative md:h-screen md:py-0 py-36 items-center overflow-hidden bg-indigo-600  bg-center bg-no-repeat bg-cover"
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px] items-center">
            ...
            <div className="shadow rounded-md p-6 bg-gradient-to-t bg-indigo-600">
              <div className="pb-8">
                ...
                <Link
                  href="#"
                  className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-orange-500 hover:bg-orange-600 border-orange-500 hover:border-orange-600 text-white rounded-md w-full"
                >
                  Started Now
                </Link>
              </div>
