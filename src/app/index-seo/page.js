...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative md:py-64 py-36 items-center  bg-center bg-no-repeat bg-cover"
        style={{ backgroundImage: "url('/images/bg-seo.png')" }}
      >
              ...
              <div className="subcribe-form mt-6 mb-3">
                <form className="relative max-w-xl mx-auto">
                  <input
                    ...
                    id="site-url"
                    name="url"
                    className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/60 dark:bg-slate-900/60 shadow dark:shadow-gray-800"
