...
export default function Page() {
  ...
  return (
    <>
      ...
      <section
        className="relative table w-full py-52 md:py-64 bg-center bg-no-repeat bg-cover"
        style={{ backgroundImage: "url('/images/crypto/bg1.jpg')" }}
      >
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-10">
                ...
                <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Buy Cryptocurrency <br /> with sinebyte
                </h3>
      ...
      <section
        className="relative md:py-24 py-16 bg-center bg-no-repeat bg-cover"
        style={{ backgroundImage: "url('/images/crypto/bg2.jpg')" }}
      >
            ...
            <div className="lg:col-span-7 md:col-span-6 order-1 md:order-2">
              <div className="lg:ms-10">
                ...
                <p className="text-slate-400 para-desc mx-auto mb-3">
                  With sinebyte Trade, you can be sure your trading skills are
                  matched with excellent service.
                </p>
                <p className="text-slate-400 para-desc mx-auto">
                  sinebyte Institutional Markets is a full-stack crypto services
                  platform that works with crypto-native businesses and
      ...
      <section
        className="relative md:py-24 py-16 bg-center bg-cover"
        style={{ backgroundImage: "url('/images/crypto/cta.jpg')" }}
      >
        <div className="container relative">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
            <div className="flex">
              ...
              <div className="flex-1">
                <h5 className="mb-2 text-xl font-semibold">
                  How our <span className="text-indigo-600">sinebyte</span> work
                  ?
                </h5>
            ...
            <div className="flex">
              ...
              <div className="flex-1">
                <h5 className="mb-2 text-xl font-semibold">
                  {" "}
                  Is <span className="text-indigo-600">sinebyte</span> safer to
                  use with my account ?
                </h5>
                <p className="text-slate-400">
