          ...
          <div className="grid grid-cols-1 items-center gap-[30px]">
            <div>
              ...
              <p className="text-slate-400 text-base leading-8">
                <strong>sinebyte</strong> is a fully responsive, clean and
                ...
                <b>Next 13.x., React 18.X and Tailwind css v3.x.</b>. sinebyte
                ...
                Social media marketing, Digital marketing/agency, Email
                Templates, Marketing, Agency, Careers and Jobs, Helpcenter, and
                much more.
              </p>
            ...
            <div>
              ...
              <p className="text-slate-400 text-base leading-8">
                ...
                build flow. In case if you dont know npm then its easy to use
                it. You can read it more about it here. Please follow below
                steps to install and setup all prerequisites:
              </p>
              ...
              <div className="relative overflow-x-auto shadow dark:shadow-gray-800 rounded-md mt-6">
                <table className="w-full text-start text-slate-500 dark:text-slate-400">
                  <thead className="text-sm uppercase bg-slate-50 dark:bg-slate-800">
                    <tr>
                      <th className="w-2/3 px-6 py-3 text-start">
                        <i className="ti-file"></i> Command
                      </th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 border-t">
                        Generates a{" "}
                        <code className="text-red-600 mx-2">.next</code>{" "}
