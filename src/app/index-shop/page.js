  ...
  return (
    <>
      ...
      <section className="relative mt-20">
        <div className="container-fluid relative">
          <div className="relative py-48 table w-full shadow-md overflow-hidden">
            <div
              className="absolute inset-0  bg-no-repeat md:bg-left bg-center bg-cover"
            ...
            <div className="md:w-1/2 p-3 picture-item">
              <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                ...
                <div className="absolute bottom-4 start-4">
                  <Link
                    href="#"
                    className="text-xl font-semibold hover:text-indigo-600 transition-all duration-500"
                  >
                    Hoodies
                  </Link>
                </div>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/shop/cta.jpg')" }}
      >
