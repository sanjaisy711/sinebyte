      ...
      <section className="relative table w-full py-32 lg:py-40 bg-gray-50 dark:bg-slate-800">
        ...
        <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
          <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
            ...
            <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-indigo-600">
              <Link href="/index-forums">Forums</Link>
            </li>
            <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180">
              <MdKeyboardArrowRight className="text-xl" />
            </li>
            <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-indigo-600">
              <Link href="/forums-topic">Topic</Link>
            </li>
            <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180">
              <MdKeyboardArrowRight className="text-xl" />
            </li>
                    ...
                    >
                      <div className="sm:flex items-center justify-between">
                        ...
                        <p className="text-slate-400 text-sm font-normal mt-3 sm:mt-0 flex items-center">
                          <GoClock className="w-4" /> 16th Januanry, 2023 at
                          03:44 pm
                        </p>
                      </div>
                      ...
                      <p className="text-slate-400 mt-4">
                        ...
                        will later be filled with real content. This is required
