          ...
          <div className="grid grid-cols-1 pb-8 text-center mt-12">
            ...
            <ul className="list-none">
              <li className="inline-flex items-center text-slate-400 me-3">
                <RiMapPinLine className="text-white h6 me-2" /> London, UK -{" "}
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1" id="reserve-form">
            <div className="lg:col-start-2 lg:col-span-10">
              ...
              <p className="text-slate-400 mb-4">
                ...
                products that exemplify the ideals of sinebyte. These ideals -
                which include peer-to-peer transactions, decentralization,
                censorship resistance, and permissionless-ness - support
                economic freedom.
              </p>
              ...
              <p className="text-slate-400 mb-4">
                ...
                financial technology products and platforms. we are bringing
