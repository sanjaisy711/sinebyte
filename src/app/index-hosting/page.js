  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/hosting/bg-hosting.jpg')" }}
      >
      ...
      <section
        className="relative md:pb-24 pb-16 bg-bottom bg-no-repeat bg-cover"
        style={{ backgroundImage: "url('/images/hosting/bg.png')" }}
      >
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
