...
export default function Page() {
  return (
    <>
      ...
      <section className="relative pb-16 pt-24">
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            <h3 className="md:text-4xl text-3xl md:leading-normal leading-normal font-semibold">
      ...
      <section
        className="relative table w-full py-44 bg-no-repeat bg-center bg-cover bg-fixed"
          ...
          <div className="grid grid-cols-1">
            <div className="rounded-md shadow dark:shadow-slate-800 bg-white dark:bg-slate-900 p-6">
              <p className="text-slate-400 text-lg">
                Suspendisse tellus dolor, lacinia vitae sapien porttitor, pos
                uere euismod justo. Curabitur enim neque, auctor ac iaculis
                vitae, efficitur quis lectus. Class aptent taciti sociosqu ad
                litora torquent per conubiays nostra, per inceptos himenaeos.
                Sed eleifend risus faucibus tortor accumsan erat volutpat.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
            ...
            <div className="lg:ms-8">
              ...
              <ul className="list-none text-slate-400 mt-4">
                <li className="mb-2 flex ms-0">
                  <MdOutlineCheckCircle className="text-indigo-600 text-xl me-2" />{" "}
              ...
              <div className="mt-4">
                ...
                >
                  Find Out More <FiChevronRight className="align-middle" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
            {servicesData.map((item, index) => {
              ...
              return (
                <div
                  className={`p-6  duration-500 rounded-2xl mt-6 text-center ${
                    item.id === 2
                      ? "shadow-xl shadow-gray-100 dark:shadow-gray-800"
                      : "hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800"
                  }`}
                  key={index}
                >
                  ...
                  <div className="content mt-7">
                    ...
                    <div className="mt-5">
                      <Link
                        ...
                        className="relative inline-flex items-center font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:duration-500 text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out"
                      >
                        Read More <FiArrowRight className="" />
                      </Link>
                    </div>
                  </div>
                </div>
