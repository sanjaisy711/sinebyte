            ...
            {digitalServices.map((item, index) => {
              ...
              return (
                <div key={index} className="text-center md:px-6">
                  <div
                    className={`${item.background} w-28 h-28  rounded-3xl text-4xl flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800 mx-auto`}
                  >
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center">
                      ...
                      <div className="mt-8">
                        <div className="section-title text-md-start">
                          ...
                          <Link
                            href="#"
                            className="text-white inline-flex items-center space-x-1"
                          >
                            Read More{" "}
