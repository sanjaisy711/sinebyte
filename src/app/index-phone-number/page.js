            ...
            <div className="md:col-span-7 md:order-2 order-1">
              <div className="ms-6">
                ...
                <p className="text-slate-400 text-lg max-w-xl">
                  sinebyte is the largest provider of custom phone numbers since
                  2020
                </p>
                ...
                <div className="subcribe-form mt-6">
                  <form className="relative max-w-xl">
                    ...
                    >
                      <LuSearch className="me-1" /> Find Number
                    </button>
                  </form>
                </div>
              </div>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
              Why People Choose sinebyte for Custom Numbers
            </h3>
            ...
            {mobileNumber.map((data, index) => {
              return (
                ...
                >
                  <Link
                    href="#"
                    className="hover:text-indigo-600 text-xl font-semibold"
                  >
                    {data.number}
                  </Link>
                  ...
                  <div className="mt-3 flex items-center justify-center">
                    ...
                    <Link
                      href="#"
                      className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full ms-3"
                    >
                      Buy Now
                    </Link>
                  </div>
          ...
          <div className="md:flex justify-center">
            <div className="lg:w-2/3 text-center">
              ...
              <p className="text-slate-400 max-w-xl mx-auto">
                ...
                services. We will send you the best of our blog just once a
                weekly.
              </p>
