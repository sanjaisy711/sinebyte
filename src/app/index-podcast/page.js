                ...
                <div className="absolute -bottom-6 -end-2">
                  <div className="bg-white dark:bg-slate-800 w- rounded-xl shadow-md dark:shadow-gray-800 w-[300px] border-b border-gray-100 dark:border-gray-600">
                    ...
                    <div className="bg-gray-50 dark:bg-slate-700 flex items-center rounded-b-xl">
                      ...
                      <button
                        type="button"
                        className="bg-white dark:bg-slate-800 flex-none -my-2 mx-auto w-20 h-20 rounded-full border border-gray-100 dark:border-gray-600 shadow-md flex items-center justify-center"
                        aria-label="Pause"
                      >
            ...
            <div className="md:col-span-7">
              <div className="lg:ms-4">
                ...
                <p className="text-slate-400 max-w-xl mb-2">
                  sinebyte Homes developed a platform for the Real Estate
                ...
                <p className="text-slate-400 max-w-xl">
                  ...
                  into the hands of the consumers. sinebyte Homes is Real Estate
                  Redefined.
                </p>
