  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/law/bg.jpg')" }}
      >
            ...
            <div className="lg:col-span-7 md:col-span-6 mt-8 md:mt-0">
              <div className="lg:ms-5">
                <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Welcome to sinebyte <br /> Law Firm Company
                </h3>
      ...
      <section
        className="pt-20 pb-32 w-full table relative bg-center bg-no-repeat bg-cover"
