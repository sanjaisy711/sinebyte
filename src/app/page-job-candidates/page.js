              ...
              return (
                ...
                >
                  <div className="mt-8">
                    ...
                    <div className="mt-3">
                      <Link
                        href={`/page-job-candidate-detail/${data.id}`}
                  ...
                  <Link
                    href="#"
                    className="bg-gray-100 dark:bg-gray-800 text-slate-400 text-xs font-medium px-3 py-1 rounded-lg h-[24px] inline-block m-1"
                  >
                    PHP
                  </Link>
                  <Link
