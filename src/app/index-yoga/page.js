...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative lg:pt-64 py-36 bg-center bg-cover"
        style={{ backgroundImage: "url('/images/yoga/bg.jpg')" }}
      >
            ...
            <div className="lg:col-span-7 md:col-span-6">
              <div className="lg:ms-5">
                <h3 className="mb-6 md:text-4xl md:leading-normal text-3xl leading-normal font-semibold">
                  The sinebyte Yoga <br /> & Meditation
                </h3>
      ...
      <section
        className="py-20 w-full table relative bg-center bg-fixed bg-no-repeat bg-cover"
        style={{ backgroundImage: "url('/images/yoga/bg02.jpg')" }}
      >
